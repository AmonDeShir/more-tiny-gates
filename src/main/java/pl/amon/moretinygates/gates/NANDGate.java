...
public class NANDGate extends AbstractGate {
  public static ResourceLocation TEXTURE_NOR_GATE_ON = ResourceLocation.fromNamespaceAndPath(MoreTinyGates.MODID, "block/nand_gate_on");
  public static ResourceLocation TEXTURE_NOR_GATE_OFF = ResourceLocation.fromNamespaceAndPath(MoreTinyGates.MODID, "block/nand_gate_off");
