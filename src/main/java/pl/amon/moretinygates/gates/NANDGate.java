...
public class NANDGate extends AbstractGate {
  public static ResourceLocation TEXTURE_NOR_GATE_ON = new ResourceLocation(MoreTinyGates.MODID, "block/nand_gate_on");
  public static ResourceLocation TEXTURE_NOR_GATE_OFF = new ResourceLocation(MoreTinyGates.MODID, "block/nand_gate_off");
